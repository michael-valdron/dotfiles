...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (scheme-complete edn pyenv-mode markdown-preview-mode neotree dracula-theme github-theme auctex ac-math pyvenv git hy-mode jedi company-jedi ipython-shell-send flycheck-clojure flycheck-pycheckers flymake-python-pyflakes company-anaconda company-shell anaconda-mode template-overlays omnisharp csharp-mode
                     (quote company)
                     (quote company-mode)
