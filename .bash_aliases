...
alias minikube-pm-start='minikube-start --driver=podman'
...
alias minikube-chestart='minikube-start --addons=ingress,dashboard --vm=true --memory=10240 --cpus=4 --disk-size=50GB --kubernetes-version=v1.23.9'
alias minikube-pm-chestart='minikube-chestart'
